...
let favoriteFoods = [ 'Roman Holiday Bake' , 'Lasagna' , 'Pizza' ];
...
console.log(`Theses are simply ${favoriteFoods.length} of my favorite foods.`);
...
console.log('Favotite foods:', favoriteFoods);
...
//     log both the food removed and the updated array
let removedFood2 = favoriteFoods.shift();
console.log('Removed food:', removedFood2);
console.log('Favorite foods:', favoriteFoods);